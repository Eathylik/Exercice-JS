...
function recupererTache(){
    let tache = JSON.parse(localStorage.getItem("data")) || []
    return tache
}
...
//premier test d'un ToDoLIst
//conclusion le premier test est un echec plein de chose sont a revoir !!!
